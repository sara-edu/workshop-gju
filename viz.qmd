...
2.  A set of [aesthetic mappings]{.rainbow-orange} between variables in the data and visual properties, and

3.  At least one layer which describes how to render each observation. Layers are usually created with a [geom]{.rainbow-orange} function.
